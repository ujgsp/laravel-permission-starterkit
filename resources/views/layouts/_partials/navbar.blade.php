<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        <div class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{ route('dashboard.index') }}" aria-label="Tabler">
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form-desktop').submit();">Logout</a>
                ...
                <div class="row flex-column flex-md-row flex-fill align-items-center">
                    <div class="col">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('dashboard/permissions*') ? 'active' : '' }}" href="{{ route('permissions.index') }}">
