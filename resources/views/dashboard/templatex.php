        ...
        <div class="card-body">
            <form method="POST">
                <div class="mb-3">
                    <div class="form-group">
                        <label class="form-label "
                               for="title">TLD <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                    <div class="form-group">
                        <label class="form-label "
                               for="email">WHOIS Server <span class="text-danger">*</span></label>
                        <input class="form-control "
                               type="text"
                               name="server"
                               id="server"
                ...
                <div class="mb-3">
                    <div class="form-group">
                        <label class="form-label "
                               for="pattern">Pattern to Match <span class="text-danger">*</span></label>
                        <textarea rows="3"
                                  class="form-control "
                                  name="pattern"
                                  id="pattern"
                ...
                <div class="mb-3">
                    <div class="form-group">
                        <label class="form-label "
                               for="affiliate_link">Affiliate Link <span class="text-danger">*</span></label>
                        <input class="form-control "
                               type="text"
                               name="affiliate_link"
                               id="affiliate_link"
                        ...
                        <small class="mt-2 text-muted d-block">This wildcard should be
                            added where the domain-name is supposed to appear in the link.</small>
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-group">
                        <label class="form-label "
                               for="price">Price (USD) <span class="text-danger">*</span></label>
                        <input class="form-control "
                               type="number"
                               step="any"
                               name="price"
                ...
                <div class="mb-3">
                    ...
                    <a href="https://domainskit.bitflan.com/admin/tlds"
